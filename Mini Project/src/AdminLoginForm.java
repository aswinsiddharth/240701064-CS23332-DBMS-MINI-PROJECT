...
public class AdminLoginForm extends JFrame {
    ...
    public AdminLoginForm(LoginForm studentLoginForm) {
        ...
        formContainer.setBackground(new Color(255, 250, 250));
        ...
        // Subtitle
        JLabel lblSubtitle = new JLabel("Authorized Access Only");
        ...
        btnLogin.setBackground(new Color(220, 53, 69));
        ...
        backPanel.setBackground(new Color(255, 250, 250));
    ...
    private void performLogin() {
        ...
        String sql = "SELECT admin_id, full_name, email FROM admins WHERE username = ? AND password = ?";
        ...
        try {
            ...
            if (rs.next()) {
                ...
                new AdminDashboard(adminId, username, fullName, email);
                this.dispose();
